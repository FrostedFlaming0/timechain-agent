...
def make_gemini_client(
    ...
    config = genai_types.GenerateContentConfig(
        ...
        temperature=temperature,
        # Set to None to keep default safety. For agent loops handling
        # structured chain content you may want to relax these.
    )
    ...
    def call(prompt: str) -> str:
        def _do():
            ...
            # resp.text concatenates all text parts; None if model returned only non-text
            return resp.text or ""
