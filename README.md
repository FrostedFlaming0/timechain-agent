...
useful in practice. It deliberately omits components of the original (e.g. qualia 
scoring) in favor of a minimal, testable foundation. The goal here is engineering 
