...
class Retriever:
    ...
    def hybrid(
        ...
        """
        Semantic search with optional type filter and recency boost.
        recency_weight of 0.0 = pure semantic; higher values prefer recent records.
        """
        ...
        for rec_idx, sim in candidates:
            ...
            score = sim + recency_weight * recency
